...
public class LeaderBoardDisplay {
    ...
    public void leaderDisplay()
    {
        ...
        leaderboardSingle( "Hangman: ");
        leaderboardSingle("Pokemon: ");
        leaderboardSingle("Punch-out: ");
    }
    ...
    /**
     * This takes a string and a filepath for the file we want to write to,
